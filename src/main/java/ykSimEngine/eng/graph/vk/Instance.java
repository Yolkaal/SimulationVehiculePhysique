...
public class Instance {
    ...
    public Instance(boolean validate) {
        Logger.log(LogLevel.DEBUG,"Creating Vulkan instance");
        try (var stack = MemoryStack.stackPush()) {
            // Create application information
            ByteBuffer appShortName = stack.UTF8("SimEngine");
            ...
            if (validate && numValidationLayers == 0) {
                ...
                Logger.log(LogLevel.WARN,"Request validation but no supported validation layers found. Falling back to no validation");
            }
            Logger.log(LogLevel.DEBUG,"Validation: {"+ supportsValidation +"}");
            ...
            if (supportsValidation) {
                ...
                for (int i = 0; i < numValidationLayers; i++) {
                    Logger.log(LogLevel.DEBUG,"Using validation layer ["+ validationLayers.get(i)+ "]");
        ...
        return VkDebugUtilsMessengerCreateInfoEXT
                ...
                .pfnUserCallback((messageSeverity, messageTypes, pCallbackData, pUserData) -> {
                    ...
                    if ((messageSeverity & VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT) != 0) {
                        Logger.log(LogLevel.INFO,DBG_CALL_BACK_PREF + callbackData.pMessageString());
                    } else if ((messageSeverity & VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT) != 0) {
                        Logger.log(LogLevel.WARN,DBG_CALL_BACK_PREF + callbackData.pMessageString());
                    } else if ((messageSeverity & VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT) != 0) {
                        Logger.log(LogLevel.ERROR,DBG_CALL_BACK_PREF + callbackData.pMessageString());
                    } else {
                        Logger.log(LogLevel.DEBUG,DBG_CALL_BACK_PREF + callbackData.pMessageString());
                    }
                    return VK_FALSE;
                });
    }
    ...
    private static Set<String> getInstanceExtensions() {
        ...
        try (var stack = MemoryStack.stackPush()) {
            ...
            Logger.log(LogLevel.TRACE,"Instance supports ["+ numExtensions + "] extensions");
            ...
            for (int i = 0; i < numExtensions; i++) {
                ...
                Logger.log(LogLevel.TRACE,"Supported instance extension ["+ extensionName +"]");
            }
        }
    ...
    private static List<String> getSupportedValidationLayers() {
        try (var stack = MemoryStack.stackPush()) {
            ...
            Logger.log(LogLevel.DEBUG,"Instance supports ["+ numLayers +"] layers");
            ...
            for (int i = 0; i < numLayers; i++) {
                ...
                Logger.log(LogLevel.TRACE,"Supported layer ["+ layerName +"]");
            }
    ...
    public void cleanup() {
        Logger.log(LogLevel.DEBUG,"Destroying Vulkan instance");
